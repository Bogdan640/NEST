...
A community application must not only be functional but also deeply intuitive and welcoming to encourage participation \cite{norman1986cognitive}.

\begin{figure}[h]
\centering
\includegraphics[width=0.92\textwidth]{figures/events_page.png}
\caption{Events page of the NEST application.}
\label{fig:events-page}
\end{figure}
