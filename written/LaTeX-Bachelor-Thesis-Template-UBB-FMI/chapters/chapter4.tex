...
To demonstrate authentification as an executable functionality, the following manual test case is performed:
...
The authentication module includes both the login and registration interfaces shown in Figures \ref{fig:login-screen} and \ref{fig:registration-screen}. These views illustrate the entry points used by residents to access the platform and create new accounts.

\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/login.png}
\caption{Login screen of the NEST application.}
\label{fig:login-screen}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{figures/registration.png}
\caption{Registration screen of the NEST application.}
